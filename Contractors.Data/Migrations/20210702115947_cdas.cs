...
{
    public partial class cdas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    ContractorAbout = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpatedOn = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Companies_AspNetUsers_ContractorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobAbout = table.Column<string>(type: "text", nullable: true),
                    JobPricing = table.Column<float>(type: "real", nullable: false),
                    JobPricingCurrency = table.Column<string>(type: "text", nullable: true),
                    JobDuration = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_ContractorId",
                table: "Companies",
                column: "ContractorId");
